...
class Monster extends Persona implements Serializable {
	...
	static final int REGENERATES=  01000000000;
	static final int UNUSED1=	   02000000000;
	static final int UNUSED2=	   04000000000;
	static final int UNUSED3=	  010000000000;
	...
	static final int MONSTERS= 26+1;	// 26, and you a monster too
	...
	static {
		...
		mon_tab[ 6]= new Montype("griffin", (ASLEEP|WAKENS|WANDERS|FLIES|REGENERATES),
	...
	static final Montype mon_old[]= new Montype[MONSTERS];
	static {
		mon_old[0]= new Montype("giant ant", (ASLEEP|WAKENS|WANDERS|STINGS),
			"1d6", 19, 'A', 10, 3, 12, 70, 0, 0);
		mon_old[1]= new Montype("bat", (ASLEEP|WANDERS|FLITS|FLIES),
			"1d2", 10, 'B', 2, 1, 8, 60, 0, 0);
		mon_old[2]= new Montype("centaur", (ASLEEP|WANDERS),
			"1d6/1d6", 32, 'C', 15, 8, 17, 85, 0, 10);
		mon_old[3]= new Montype("dragon", (ASLEEP|WAKENS|FLAMES),
			"1d8/1d8/3d10", 145, 'D', 5000, 22, 126, 100, 0, 90);
		mon_old[4]= new Montype("floating eye", (ASLEEP|FREEZES),
			"0d0", 15, 'E',  5, 2, 11, 68, 0, 0);
		mon_old[5]= new Montype("violet fungi", (HOLDS|STATIONARY),
			"5d5", 73, 'F', 91, 15, 24, 80, 0, 0);
		mon_old[6]= new Montype("gnome", (ASLEEP|WAKENS|WANDERS),
			"1d6", 20, 'G', 9, 6, 15, 67, 0, 0);
		mon_old[7]= new Montype("hobgoblin", (ASLEEP|WAKENS|WANDERS),
			"1d3/1d2", 15, 'H', 3, 1, 10, 67, 0, 0);	// was 1d8, too mean!
		mon_old[8]= new Montype("invisible stalker", (ASLEEP|INVISIBLE|WANDERS|FLITS),
			"4d4", 76, 'I', 120, 16, 25, 80, 0, 50);
		mon_old[9]= new Montype("jackal", (ASLEEP|WAKENS),
			"1d2", 11, 'J', 2, 1, 7, 65, 0, 0);
		mon_old[10]= new Montype("kobold", (ASLEEP|WAKENS|WANDERS),
			"1d4", 10, 'K', 2, 1, 6, 60, 0, 0);
		mon_old[11]= new Montype("leprechaun", (ASLEEP|STEALS_GOLD),
			"1d1", 25, 'L', 21, 7, 16, 75, 0, 0);
		mon_old[12]= new Montype("mimic", (ASLEEP|IMITATES),
			"3d4", 42, 'M', 110, 19, 126, 75, 0, 0);
		mon_old[13]= new Montype("nymph", (ASLEEP|STEALS_ITEM),
			"0d0", 25, 'N', 39, 11, 20, 75, 0, 100);
		mon_old[14]= new Montype("orc", (ASLEEP|WANDERS|WAKENS|SEEKS_GOLD),
			"1d8", 25, 'O', 5, 4, 13, 70, 0, 10);
		mon_old[15]= new Montype("purple worm", (ASLEEP|WANDERS),
			"2d12/2d4", 132, 'P', 3000, 21, 126, 100, 0, 0);
		mon_old[16]= new Montype("quasit", (ASLEEP|WAKENS|WANDERS),
			"1d2/1d2/1d4", 30, 'Q', 20, 10, 19, 78, 0, 20);
		mon_old[17]= new Montype("rust monster", (ASLEEP|WAKENS|WANDERS|RUSTS),
			"0d0/0d0", 25, 'R', 20, 9, 18, 100,  0, 0);
		mon_old[18]= new Montype("snake", (ASLEEP|WAKENS|WANDERS),
			"1d3", 8, 'S', 2, 1, 9, 50, 0, 0);
		mon_old[19]= new Montype("troll", (ASLEEP|WAKENS|WANDERS|REGENERATES),
			"1d8/1d8/2d6", 75, 'T', 125, 13, 22, 75, 0, 33);
		mon_old[20]= new Montype("umber hulk", (ASLEEP|WAKENS|WANDERS|CONFUSES),
			"3d4/3d4/2d5", 97, 'U', 250, 18, 126, 85, 0, 25);
		mon_old[21]= new Montype("vampire", (ASLEEP|WAKENS|WANDERS|DRAINS_LIFE|REGENERATES),
			"1d10", 55, 'V', 350, 20, 126, 85, 0, 18);
		mon_old[22]= new Montype("wraith", (ASLEEP|WANDERS|DROPS_LEVEL),
			"1d6", 45, 'W', 55, 14, 23, 75, 0, 0);
		mon_old[23]= new Montype("xorn", (ASLEEP|WAKENS|WANDERS),
			"1d3/1d3/1d3/4d6", 90, 'X', 200, 17, 26, 85, 0, 33);
		mon_old[24]= new Montype("yeti", (ASLEEP|WANDERS),
			"1d6/1d6", 35, 'Y', 50, 12, 21, 80, 0, 20);
		mon_old[25]= new Montype("zombie", (ASLEEP|WAKENS|WANDERS),
			"1d8", 21, 'Z', 8, 5, 14, 69, 0, 0);
		mon_old[26]= new Montype("rogue", 0,
			"1d7", 12, '@', 1, -1, -1, 90, 0, 0);
	}
	...
	static void setoldstyle(boolean bOld){
		if(isold != bOld){
			isold= bOld;
			for(int k= 0; k<MONSTERS; k++){
				Montype mt= mon_tab[k];
				mon_tab[k]= mon_old[k];
				mon_old[k]= mt;
			}
		}	
	...
	void mon_hit(Persona man){
		...
		if(0!=(m_flags & REGENERATES)){
			if(hp_current<hp_max && self.rand.percent(25))
				++hp_current;
		}
	...
	void die(Persona man){
		...
		if(self.rand.percent(self.gorepct))
	...
	int color(){
		if(self.view.man.option.colormonster){
			if(0 != (m_flags & (ASLEEP | NAPPING)))
				return uGreen;
			if(3*hp_current <= hp_max)
				return uWeak;
		}
		return uNormal;
	}
	String name(){
		int i= ichar;
		if(self.view.man.halluc>0)
			i= self.rand.get('A','Z');
		return mon_tab[i-'A'].m_name;
	}
}
